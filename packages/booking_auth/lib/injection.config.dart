...
import 'infrastructure/auth/datasources/local/auth/i_login_local_datasource.dart' as _i8;
import 'infrastructure/auth/datasources/local/auth/login_local_datasources.dart' as _i6;
...
import 'infrastructure/auth/datasources/remote/i_auth_remote_datasources.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i4.InternetConnectionChecker>(() => injectionModules.internetConnectionChecker);
    gh.lazySingleton<_i5.FirebaseAuth>(() => injectionModules.firebaseAuth);
    gh.lazySingleton<_i6.LoginLocalDataSource>(() => _i7.ILoginLocalDataSource(gh<_i3.SharedPreferences>()));
    gh.lazySingleton<_i8.NetworkInfo>(() => _i9.INetworkInfo(gh<_i4.InternetConnectionChecker>()));
    gh.lazySingleton<_i10.LoginApi>(() => registerApi.getloginApi(gh<_i11.Dio>()));
    gh.factory<_i12.IAuthRemoteDataSources>(() => _i12.IAuthRemoteDataSources(firebaseAuth: gh<_i5.FirebaseAuth>()));

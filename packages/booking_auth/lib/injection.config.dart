...
import 'infrastructure/auth/datasources/local/auth/login_local_datasources.dart'
    as _i7;
import 'infrastructure/auth/datasources/remote/api/login_api.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i9.NetworkInfo>(
        () => _i10.INetworkInfo(gh<_i5.InternetConnectionChecker>()));
    gh.lazySingleton<_i11.LoginApi>(
